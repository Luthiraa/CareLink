...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // while (run) {
            ...
            double userLatitude = Double.parseDouble(locationParts[10].split(":")[1].trim());
            double userLongitude = Double.parseDouble(locationParts[10].split(":")[1].trim());
