...
public class healthStats {
    ...
    public void healthStat() {
        ...
        for (i = 0; i < text.length(); i++) {
            ...
            // set option equal to 0, which will be used to get the choice that the user
            // picks to naviaget menu
            int option = 0;
    ...
    public static void heartHealth(Scanner scan, String dateString) {
        ...
        clearScreen();
        // call image function and reference heartbeat.jpg to display on a seperate
        // window
        ...
        try {
            ...
            System.out.println(
                    "Were you performing any physical activities before you measured your heart rate? Please enter either \"y\" or \"n\"");
        ...
        try {
            ...
            while (low <= high) {
                ...
                if (fileContents[mid].equals(searchStr)) {
                    ...
                    found = true;
                    break;
                    // .compareTo(searchStr) is a method that compares the retrieved string value
                    // with the search string value.
                    // < 0 checks whether the comparison result is less than zero, indicating that
                    // the retrieved value is less than the search value.
     ...
     *
     */
    // This function prompts the user to enter the weight and height of multiple
    // people and calculates their BMI (Body Mass Index)
    public static void BMI() {
        ...
        // Prompt the user to enter the weight and height for each person and store the
        // data in the 2D array
    ...
    public static void ScreenTime(String dateString) {
        ...
        try {
            ...
            // initialize Scanner object for reading data from the "screentime.csv" file and
    ...
    public static void bloodPressureFunction(Scanner scan, String dateString) {
        ...
        switch (option) {
            case 1:
                ...
                clearScreen();
                System.out.println(
                        "Read the following instructions if you have a manometer... Close the tab to continue....");
                image("images/bp.jpg");
                System.out.println("Press enter to continue...");
                scan.nextLine();
                clearScreen();
                ...
                if (bloodPressureInt.equals("0")) {
                    ...
                    try {
                        ...
                        System.out.println(
                                "Were you performing any physical activities before you measured your heart rate? " +
